...
static partial class Pull
{
    ...
    /// </summary>
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool @return<A, B>(in StackFrame frame, in A value1, in B value2)
    {
    ...
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool dup<A>(in StackFrame frame) =>
        frame.vars.Dup<A>();
    ...
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B, C>(in StackFrame frame, out A value1, out B value2, out C value3)
    {
    ...
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B, C, D>(in StackFrame frame, out A value1, out B value2, out C value3, out D value4) =>
        frame.vars.Pop(out value1, out value2, out value3, out value4);

    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B, C, D, E>(in StackFrame frame, out A value1, out B value2, out C value3, out D value4, out E value5) =>
        frame.vars.Pop(out value1, out value2, out value3, out value4, out value5);

    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B, C, D, E, F>(in StackFrame frame, out A value1, out B value2, out C value3, out D value4, out E value5, out F value6) =>
        frame.vars.Pop(out value1, out value2, out value3, out value4, out value5, out value6);

    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B, C, D, E, F, G>(in StackFrame frame, out A value1, out B value2, out C value3, out D value4, out E value5, out F value6, out G value7) =>
        frame.vars.Pop(out value1, out value2, out value3, out value4, out value5, out value6, out value7);

    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B>(in StackFrame frame, out A value1, out B value2)
    {
    ...
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A>(in StackFrame frame) =>
        frame.vars.Pop<A>(false);

    [MethodImpl(Optimisations.InliningOnly)]
    public static bool pop<A, B>(in StackFrame frame) =>
        frame.vars.Pop<A, B>(false);
    
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool peek<A>(in StackFrame frame, out A value) =>
        frame.vars.Peek(out value);
    
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool peek<A, B>(in StackFrame frame, out A value1, out B value2) =>
        frame.vars.Peek(out value1, out value2);
    
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool push<A>(in StackFrame frame, in A value) =>
        frame.vars.Push(in value, false);
    
    [MethodImpl(Optimisations.InliningOnly)]
    public static bool push<A, B>(in StackFrame frame, in A value1, in B value2) =>
